...
spec_options_data <- filter(spec_options_data, !(spec_options_data$Option == 'CPSC (International)' | spec_options_data$Option == 'CPSC (Domestic)')) # Remove CPSC 
...
spec_data_comp_2021 <- filter(spec_data, (spec_data$Year == 2021) & (spec_data$min_grade > 75) & !spec_data$Option == 'CPSC (Domestic)' & !spec_data$Option == "CPSC (International)")
...
```{r}
specialization_requirement_change(2017, 2020, 83)
```
